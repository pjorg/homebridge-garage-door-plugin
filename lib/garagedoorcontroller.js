...
class GarageDoorController
{
    ...
    constructor(log, options)
    {
        ...
        this.log = log;
        this.last_open_state = rpio.HIGH;
        this.last_close_state = rpio.HIGH;
        ...
        try
        {
            rpio.open(this.options.open_pin, rpio.INPUT, rpio.PULL_UP);
            rpio.open(this.options.close_pin, rpio.INPUT, rpio.PULL_UP);
